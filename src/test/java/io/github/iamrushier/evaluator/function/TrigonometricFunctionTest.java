...
class TrigonometricFunctionTest {
    ...
    void handleSin_specialAngles_returnsCorrectResult() {
        assertEquals("0.0", TrigonometricFunction.handleSin(BigDecimal.ZERO));
        assertEquals("0.5", TrigonometricFunction.handleSin(new BigDecimal("30")));
        assertEquals("1.0", TrigonometricFunction.handleSin(new BigDecimal("90")));
        assertEquals("0.5", TrigonometricFunction.handleSin(new BigDecimal("150")));
        assertEquals("0.0", TrigonometricFunction.handleSin(new BigDecimal("180")));
        assertEquals("-0.5", TrigonometricFunction.handleSin(new BigDecimal("210")));
        assertEquals("-1.0", TrigonometricFunction.handleSin(new BigDecimal("270")));
        assertEquals("-0.5", TrigonometricFunction.handleSin(new BigDecimal("330")));
    }

    @Test
    void handleSin_normalizedAngles_returnsCorrectResult() {
        assertEquals("0.0", TrigonometricFunction.handleSin(new BigDecimal("360")));
        assertEquals("1.0", TrigonometricFunction.handleSin(new BigDecimal("450")));
        assertEquals("-1.0", TrigonometricFunction.handleSin(new BigDecimal("-90")));
    }
    ...
    void handleCos_specialAngles_returnsCorrectResult() {
        assertEquals("1.0", TrigonometricFunction.handleCos(BigDecimal.ZERO));
        assertEquals("0.5", TrigonometricFunction.handleCos(new BigDecimal("60")));
        assertEquals("0.0", TrigonometricFunction.handleCos(new BigDecimal("90")));
        assertEquals("-0.5", TrigonometricFunction.handleCos(new BigDecimal("120")));
        assertEquals("-1.0", TrigonometricFunction.handleCos(new BigDecimal("180")));
        assertEquals("-0.5", TrigonometricFunction.handleCos(new BigDecimal("240")));
        assertEquals("0.0", TrigonometricFunction.handleCos(new BigDecimal("270")));
        assertEquals("0.5", TrigonometricFunction.handleCos(new BigDecimal("300")));
    }

    @Test
    void handleCos_normalizedAngles_returnsCorrectResult() {
        assertEquals("1.0", TrigonometricFunction.handleCos(new BigDecimal("360")));
        assertEquals("0.0", TrigonometricFunction.handleCos(new BigDecimal("450")));
        assertEquals("0.0", TrigonometricFunction.handleCos(new BigDecimal("-270")));
    }
    ...
    void handleTan_specialAngles_returnsCorrectResult() {
        assertEquals("0.0", TrigonometricFunction.handleTan(BigDecimal.ZERO));
        assertEquals("1.0", TrigonometricFunction.handleTan(new BigDecimal("45")));
        assertEquals("Infinity", TrigonometricFunction.handleTan(new BigDecimal("90")));
        assertEquals("-1.0", TrigonometricFunction.handleTan(new BigDecimal("135")));
        assertEquals("0.0", TrigonometricFunction.handleTan(new BigDecimal("180")));
        assertEquals("1.0", TrigonometricFunction.handleTan(new BigDecimal("225")));
        assertEquals("-Infinity", TrigonometricFunction.handleTan(new BigDecimal("270")));
        assertEquals("-1.0", TrigonometricFunction.handleTan(new BigDecimal("315")));
    }

    @Test
    void handleTan_normalizedAngles_returnsCorrectResult() {
        assertEquals("0.0", TrigonometricFunction.handleTan(new BigDecimal("360")));
    ...
    void handleAsin_specialValues_returnsCorrectResult() {
        assertEquals("30.0", TrigonometricFunction.handleAsin(new BigDecimal("0.5")));
        assertEquals("90.0", TrigonometricFunction.handleAsin(BigDecimal.ONE));
        assertEquals("-30.0", TrigonometricFunction.handleAsin(new BigDecimal("-0.5")));
        assertEquals("-90.0", TrigonometricFunction.handleAsin(BigDecimal.valueOf(-1)));
    }
    ...
    void handleAcos_specialValues_returnsCorrectResult() {
        assertEquals("60.0", TrigonometricFunction.handleAcos(new BigDecimal("0.5")));
        assertEquals("0.0", TrigonometricFunction.handleAcos(BigDecimal.ONE));
        assertEquals("120.0", TrigonometricFunction.handleAcos(new BigDecimal("-0.5")));
        assertEquals("180.0", TrigonometricFunction.handleAcos(BigDecimal.valueOf(-1)));
    }
    ...
    void handleAcos_generalValues_returnsCorrectResult() {
        BigDecimal value = new BigDecimal("0.7071067811865476"); // cos(45 degrees)
        assertEquals("45.0", TrigonometricFunction.handleAcos(value));
    }

    @Test
    void handleAtan_specialValues_returnsCorrectResult() {
        assertEquals("90.0", TrigonometricFunction.handleAtan("Infinity"));
        assertEquals("-90.0", TrigonometricFunction.handleAtan("-Infinity"));
